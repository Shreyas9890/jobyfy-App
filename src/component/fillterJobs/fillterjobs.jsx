...
const FilterSection = (props) => {
  ...
  const { changeEmp, changeSalary } = props;
  ...
  const onChangeEmpType = (event) => {
    changeEmp(event.target.value, event.target.checked);
  }

  const onChangeSalaryRange = (event) => {
    changeSalary(event.target.value); // Pass the selected salary range value to the parent
  };
